...
if [ "$(uname)" == "Darwin" ]; then
    # Mac OS X platform
    sudo curl -o /usr/local/bin/jssl -s https://raw.githubusercontent.com/pmamico/java-ssl-tools/main/jssl && sudo chmod +x /usr/local/bin/jssl
    ...
    curl -o "$HOME"/bin/jssl -s https://raw.githubusercontent.com/pmamico/java-ssl-tools/main/jssl
